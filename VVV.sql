/******************************************************************************/
/****         Generated by IBExpert 2006.12.13 12/08/2007 16.16.34         ****/
/******************************************************************************/
...
CREATE TABLE FILES (
    ...
    PATH_ID           BIGINT,
    PATH_FILE_ID      BIGINT,
    FILE_DESCRIPTION  BLOB SUB_TYPE 1 SEGMENT SIZE 4096 CHARACTER SET ISO8859_1
);
...
CREATE TABLE FILES_AUDIO_METADATA (
    ...
    TRACK_YEAR         INTEGER,
    TRACK_COMMENT      AUDIO_METADATA_TEXT,
...
CREATE TABLE PATHS (
    ...
    FATHER_ID         BIGINT,
    PATH_DESCRIPTION  BLOB SUB_TYPE 1 SEGMENT SIZE 4096 CHARACTER SET ISO8859_1
);
...
INSERT INTO SERVICE (SERVICE_ID, DB_VERSION) VALUES (1, 12);
