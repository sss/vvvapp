/******************************************************************************/
/*            Generated by IBExpert 2008.02.19 19/04/2008 9.46.58             */
/******************************************************************************/
...
VARCHAR(2048) CHARACTER SET ISO8859_1;

CREATE DOMAIN LONG_TEXT AS
VARCHAR(500) CHARACTER SET ISO8859_1;
...
CREATE TABLE VOLUMES (
    ...
    VOLUME_DESCRIPTION  BLOB SUB_TYPE 1 SEGMENT SIZE 4096 CHARACTER SET ISO8859_1
);
...
SET RDB$DESCRIPTION = 'This table contains service data'
WHERE (RDB$RELATION_NAME = 'SERVICE');

UPDATE RDB$RELATIONS
SET RDB$DESCRIPTION = 'Stores the folders structure for the virtual view'
...
SET RDB$DESCRIPTION = 'Assigns the contents of the physical path to then virtual path.
It will not create duplicate files or folders.'
WHERE (RDB$PROCEDURE_NAME = 'SP_ADD_PHYSPATH_TO_VIRTUALPATH');

UPDATE RDB$PROCEDURES
SET RDB$DESCRIPTION = 'Appends the physical folder and its contents to a child of the virtual folder.
...
UPDATE RDB$PROCEDURES
SET RDB$DESCRIPTION = 'Returns -1 if then pathname is already present in the database'
WHERE (RDB$PROCEDURE_NAME = 'SP_CREATE_UNIQUE_VIRTUALPATH');

UPDATE RDB$PROCEDURES
SET RDB$DESCRIPTION = 'If there is not a virtual folder with the specied name creates that folder
...
UPDATE RDB$PROCEDURES
SET RDB$DESCRIPTION = 'Returns the full path of a given PATH_ID.'
WHERE (RDB$PROCEDURE_NAME = 'SP_GET_FULL_PATH');

UPDATE RDB$PROCEDURES
SET RDB$DESCRIPTION = 'Returns FILES.FILE_ID of the row corresponding to the value of
PATHS.PATH_ID received as a parameter'
WHERE (RDB$PROCEDURE_NAME = 'SP_GET_PHYS_FILEID_FROM_PATHID');

UPDATE RDB$PROCEDURES
SET RDB$DESCRIPTION = 'Changes the name of a virtual folder created by the user: no link to physical path.'
...
SET RDB$DESCRIPTION = 'If PATH_ID is null this row represents a virtual folder created by the user.'
WHERE (RDB$RELATION_NAME = 'FILES') AND (RDB$FIELD_NAME = 'PATH_ID');

UPDATE RDB$RELATION_FIELDS
SET RDB$DESCRIPTION = 'This field is NULL if the row represents a file.
...
WHERE (RDB$RELATION_NAME = 'FILES') AND (RDB$FIELD_NAME = 'PATH_FILE_ID');

UPDATE RDB$RELATION_FIELDS
SET RDB$DESCRIPTION = 'TRACK LENGTH IN SECONDS'
WHERE (RDB$RELATION_NAME = 'FILES_AUDIO_METADATA') AND (RDB$FIELD_NAME = 'TRACK_LENGTH');

UPDATE RDB$RELATION_FIELDS
SET RDB$DESCRIPTION = 'ID of the path of the father folder, NULL if none'
WHERE (RDB$RELATION_NAME = 'PATHS') AND (RDB$FIELD_NAME = 'FATHER_ID');
...
WHERE (RDB$RELATION_NAME = 'VIRTUAL_FILES') AND (RDB$FIELD_NAME = 'VIRTUAL_PATH_FILE_ID');

UPDATE RDB$RELATION_FIELDS
SET RDB$DESCRIPTION = 'Points the corresponding real folder, if there is one.
If this is a virtual path created by the user it is NULL.'
WHERE (RDB$RELATION_NAME = 'VIRTUAL_PATHS') AND (RDB$FIELD_NAME = 'PHYS_PATH_ID');
...
SET RDB$DESCRIPTION = 'FILES.FILE_ID of the file to be added'
WHERE (RDB$PROCEDURE_NAME = 'SP_ADD_PHYSFILE_TO_VIRTUALPATH') AND (RDB$PARAMETER_NAME = 'PHYS_FILE_ID');

UPDATE RDB$PROCEDURE_PARAMETERS
SET RDB$DESCRIPTION = 'Primary key of the virtual folder that will receive the file'
WHERE (RDB$PROCEDURE_NAME = 'SP_ADD_PHYSFILE_TO_VIRTUALPATH') AND (RDB$PARAMETER_NAME = 'VIRTUAL_PATH_ID');

UPDATE RDB$PROCEDURE_PARAMETERS
SET RDB$DESCRIPTION = 'The SP returns -1 if the folder name is already present'
WHERE (RDB$PROCEDURE_NAME = 'SP_CREATE_UNIQUE_VIRTUALPATH') AND (RDB$PARAMETER_NAME = 'VPATH_ID');

UPDATE RDB$PROCEDURE_PARAMETERS
SET RDB$DESCRIPTION = 'If = 1 it also creates a virtual file corresponding to the created virtual folder.'
WHERE (RDB$PROCEDURE_NAME = 'SP_CREATE_VIRTUALPATH') AND (RDB$PARAMETER_NAME = 'CREATE_VIRTUAL_FOLDER_FILE');

UPDATE RDB$PROCEDURE_PARAMETERS
SET RDB$DESCRIPTION = '0=OK, -1=error: new name would be duplicated'
WHERE (RDB$PROCEDURE_NAME = 'SP_RENAME_VIRTUALPATH') AND (RDB$PARAMETER_NAME = 'STATUS');
