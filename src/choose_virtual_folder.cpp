...
////@begin CDialogChooseVirtualFolder event table entries
    EVT_TREE_SEL_CHANGED( ID_TREECTRL_CHOOSE, CDialogChooseVirtualFolder::OnTreectrlChooseSelChanged )
...
////@begin CDialogChooseVirtualFolder content construction
    // Generated by DialogBlocks, 16/04/2007 18:19:23 (unregistered)
...
void CDialogChooseVirtualFolder::OnTreectrlChooseSelChanged( wxTreeEvent& event )
{
	wxTreeItemId itemID = event.GetItem();
	if( itemID.IsOk() ) {
