...
////@begin CMainFrame content construction
    // Generated by DialogBlocks, 13/04/2007 14:42:00 (unregistered)
    ...
    itemTreeCtrl14->Connect(ID_TREE_CONTROL, wxEVT_CONTEXT_MENU, wxContextMenuEventHandler(CMainFrame::OnTreeControlContextMenu), NULL, this);
...
{
////@begin wxEVT_CONTEXT_MENU event handler for ID_TREE_CONTROL in CMainFrame.
    // Before editing this code, remove the block markers.
	...
	event.Skip();
////@end wxEVT_CONTEXT_MENU event handler for ID_TREE_CONTROL in CMainFrame. 
}
