...
////@begin CMainFrame content construction
    // Generated by DialogBlocks, 04/01/2007 10:41:31 (unregistered)
...
void CMainFrame::LoadTreeControl(void) {
	...
	//wxTreeItemId itemID1 = tctl->AppendItem( rootID, wxT("Item1"), 0, 0, new MyTreeItemData(wxT("Item 1")) );
	//wxTreeItemId itemID12 = tctl->AppendItem( itemID1, wxT("Item12"), 1, 2, new MyTreeItemData(wxT("Item 12")) );
	//wxTreeItemId itemID2 = tctl->AppendItem( rootID, wxT("Item2"), 0, 0, new MyTreeItemData(wxT("Item 2")) );
}
...
void CMainFrame::LoadVolumeInTreeControl( CVolumes vol, wxTreeCtrl* tctl, wxTreeItemId rootID ) {
	...
	wxTreeItemId volumeID = tctl->AppendItem( rootID, vol.VolumeName, 0, 0, 
							new MyTreeItemData(vol.VolumeName, vol.VolumeID, 0, true) );
