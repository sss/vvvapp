...
////@begin CMainFrame content construction
    // Generated by DialogBlocks, 20/04/2007 12:04:28 (unregistered)
    ...
    itemMenu7->AppendSeparator();
    itemMenu7->Append(ID_ADD_VIRTUAL_FOLDER, _("Rename Virtual Folder"), _T(""), wxITEM_NORMAL);
    itemMenu7->Append(D_DELETE_VIRTUAL_FOLDER, _("Delete Virtual Folder"), _T(""), wxITEM_NORMAL);
    menuBar->Append(itemMenu7, _("Edit"));
    wxMenu* itemMenu15 = new wxMenu;
    itemMenu15->Append(ID_CATALOG_VOLUME, _("Catalog Volume"), _T(""), wxITEM_NORMAL);
    menuBar->Append(itemMenu15, _("Volumes"));
    wxMenu* itemMenu17 = new wxMenu;
    itemMenu17->Append(ID_VIEW_PHYSICAL, _("Physical View"), _T(""), wxITEM_RADIO);
    itemMenu17->Check(ID_VIEW_PHYSICAL, true);
    itemMenu17->Append(ID_VIEW_VIRTUAL, _("Virtual View"), _T(""), wxITEM_RADIO);
    menuBar->Append(itemMenu17, _("View"));
    itemFrame1->SetMenuBar(menuBar);

    wxStatusBar* itemStatusBar20 = new wxStatusBar( itemFrame1, ID_STATUSBAR1, wxST_SIZEGRIP );
    itemStatusBar20->SetFieldsCount(2);
    itemFrame1->SetStatusBar(itemStatusBar20);

    wxSplitterWindow* itemSplitterWindow21 = new wxSplitterWindow( itemFrame1, ID_SPLITTERWINDOW1, wxDefaultPosition, wxSize(100, 100), wxSP_3DBORDER|wxSP_3DSASH|wxSP_NO_XP_THEME|wxNO_BORDER );
    itemSplitterWindow21->SetMinimumPaneSize(0);

    wxTreeCtrl* itemTreeCtrl22 = new wxTreeCtrl( itemSplitterWindow21, ID_TREE_CONTROL, wxDefaultPosition, wxSize(100, 100), wxTR_HAS_BUTTONS |wxTR_HIDE_ROOT|wxTR_SINGLE|wxNO_BORDER|wxTR_DEFAULT_STYLE );

    wxListCtrl* itemListCtrl23 = new wxListCtrl( itemSplitterWindow21, ID_LIST_CONTROL, wxDefaultPosition, wxSize(100, 100), wxLC_REPORT|wxNO_BORDER );

    itemSplitterWindow21->SplitVertically(itemTreeCtrl22, itemListCtrl23, 50);

    // Connect events and objects
    itemTreeCtrl22->Connect(ID_TREE_CONTROL, wxEVT_CONTEXT_MENU, wxContextMenuEventHandler(CMainFrame::OnTreeControlContextMenu), NULL, this);
