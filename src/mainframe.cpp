...
////@begin CMainFrame content construction
    // Generated by DialogBlocks, 16/04/2007 10:00:39 (unregistered)
    ...
    itemMenu12->Append(ID_CATALOG_VOLUME, _("Catalog Volume"), _T(""), wxITEM_NORMAL);
    menuBar->Append(itemMenu12, _("Volumes"));
    wxMenu* itemMenu14 = new wxMenu;
    itemMenu14->Append(ID_VIEW_PHYSICAL, _("Physical View"), _T(""), wxITEM_RADIO);
    itemMenu14->Check(ID_VIEW_PHYSICAL, true);
    itemMenu14->Append(ID_VIEW_VIRTUAL, _("Virtual View"), _T(""), wxITEM_RADIO);
    menuBar->Append(itemMenu14, _("View"));
    itemFrame1->SetMenuBar(menuBar);

    wxStatusBar* itemStatusBar17 = new wxStatusBar( itemFrame1, ID_STATUSBAR1, wxST_SIZEGRIP );
    itemStatusBar17->SetFieldsCount(2);
    itemFrame1->SetStatusBar(itemStatusBar17);

    wxSplitterWindow* itemSplitterWindow18 = new wxSplitterWindow( itemFrame1, ID_SPLITTERWINDOW1, wxDefaultPosition, wxSize(100, 100), wxSP_3DBORDER|wxSP_3DSASH|wxSP_NO_XP_THEME|wxNO_BORDER );
    itemSplitterWindow18->SetMinimumPaneSize(0);

    wxTreeCtrl* itemTreeCtrl19 = new wxTreeCtrl( itemSplitterWindow18, ID_TREE_CONTROL, wxDefaultPosition, wxSize(100, 100), wxTR_HAS_BUTTONS |wxTR_HIDE_ROOT|wxTR_SINGLE|wxNO_BORDER|wxTR_DEFAULT_STYLE );

    wxListCtrl* itemListCtrl20 = new wxListCtrl( itemSplitterWindow18, ID_LIST_CONTROL, wxDefaultPosition, wxSize(100, 100), wxLC_REPORT|wxNO_BORDER );

    itemSplitterWindow18->SplitVertically(itemTreeCtrl19, itemListCtrl20, 50);

    // Connect events and objects
    itemTreeCtrl19->Connect(ID_TREE_CONTROL, wxEVT_CONTEXT_MENU, wxContextMenuEventHandler(CMainFrame::OnTreeControlContextMenu), NULL, this);
