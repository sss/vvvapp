...
UPDATE RDB$RELATION_FIELDS set RDB$DESCRIPTION = 'ID of the path of the father forlder, NULL if none'  where RDB$FIELD_NAME = 'FATHER_ID' and RDB$RELATION_NAME = 'PATHS';
